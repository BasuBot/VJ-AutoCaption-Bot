...
try: app_id = int(os.environ.get("app_id", "27183261"))
except Exception as app_id: print(f"⚠️ App ID Invalid {app_id}")
try: api_hash = os.environ.get("api_hash", "f32586203fd2d814ea949ad984839c61")
except Exception as api_id: print(f"⚠️ Api Hash Invalid {api_hash}")
try: bot_token = os.environ.get("bot_token", "6685337441:AAH_DRfzvFzhhNiDHinxJYmOGLABb2KmakU")
...
about_message = """
<b>• Name : <a href=https://t.me/PrimeOrignal>VJ AutoCaption</a></b>
<b>• Developer : <a href=https://t.me/PrimeOrignal>[VJ UPDATES]</a></b>
<b>• Language : Python3</b>
<b>• Library : Pyrogram v{version}</b>
<b>• Updates : <a href=https://t.me/PrimeOrignal>Click Here</a></b>
...
def start_buttons(bot, update):
  bot = bot.get_me()
  buttons = [[
   pyrogram.types.InlineKeyboardButton("Updates", url="t.me/@PrimeOrignal"),
   pyrogram.types.InlineKeyboardButton("About 🤠", callback_data="about")
   ],[
   pyrogram.types.InlineKeyboardButton("➕️ Add To Your Channel ➕️", url=f"http://t.me/{bot.PrimeAutoCaptionBot}?startchannel=true")
   ]]
...
print("Bot Created By https://t.me/PrimeOrignal")
